  ...
  _setMdText(value = '') {
    ...
    this.renderHTML(text)
      .then(html => {
        ...
        console.log("节点加载完毕")
          //- echarts
        let echartsArray = document.getElementsByClassName('echarts')
        if(echartsArray.length > 0){
          let echartsLen = echartsArray.length;

          let echartsData  =  document.getElementsByClassName('echarts-data')
          let echartsChart = [];
          let echartsOption = [];
          for (let j = 0; j < echartsLen; j++) {
            echartsChart[j] = echarts.init(echartsArray[j]);
            echartsOption[j] = JSON.parse( echartsData[j].innerHTML).option;
        ...
        <NavigationBar
          left={
            <div className="button-wrap">
              ...
              <span className="button" title="highlight" onClick={() => this.handleDecorate('highlight')}><Icon type="icon-pencil" /></span>
              ...
              <span className="button" title="平方" onClick={() => this.handleDecorate('square')}><Icon type="icon-superscript" /></span>
              <span className="button" title="三次方" onClick={() => this.handleDecorate('cube')}><Icon type="icon-cube" /></span>              
              ...
              <span className="button" title="checked" onClick={() => this.handleDecorate('checked')}><Icon type="icon-checked" /></span>
              <span className="button" title="uncheck" onClick={() => this.handleDecorate('uncheck')}><Icon type="icon-uncheck" /></span>
              {/* <span className="button" title="gantt" onClick={() => this.handleDecorate('gantt')}><Icon type="icon-gantt" /></span> */}
              <span className="button" title="插入目录" onClick={() => this.handleDecorate('catalogue')}><Icon type="icon-catalogue" /></span>
              ...
              <span className="button" title="插入柱状图" onClick={() => this.handleDecorate('bar')}><Icon type="icon-bar" /></span>
              <span className="button" title="插入折线图" onClick={() => this.handleDecorate('line')}><Icon type="icon-line" /></span>
              <span className="button" title="插入饼状图" onClick={() => this.handleDecorate('pie')}><Icon type="icon-pie" /></span>
